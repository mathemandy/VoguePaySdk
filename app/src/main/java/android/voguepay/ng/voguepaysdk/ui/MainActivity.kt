...
//        loadMainFragment()
    ...
    private fun validateEntries() {
        ...
        if (valid) {
            VoguePayManager.Builder()
                .setTransactionAmount(amoutToCharge.toInt())
                ...
                .withCard(cardPaymentSwitch.isChecked)
                .withAcccount(accountPaymentSwitch.isChecked)
